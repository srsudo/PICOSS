...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.load_button.setText(_translate("Visualize other stations", "Load", None))
        self.label_4.setText(_translate("Visualize other stations", "<html><head/><body><p><span style=\" font-weight:600;\">Sampling Freq (Hz)</span></p></body></html>", None))
        self.label_5.setText(_translate("Visualize other stations", "<html><head/><body><p><span style=\" font-weight:600;\">High_pass Freq (Hz)</span></p></body></html>", None))
        self.label_7.setText(_translate("Visualize other stations", "<html><head/><body><p align=\"center\"><span style=\" font-weight:600;\">Modify Trace Parameters</span></p></body></html>", None))
        self.label_3.setText(_translate("Visualize other stations", "<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600;\">Main Window current event</span></p></body></html>", None))
        self.label.setText(_translate("Visualize other stations", "<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600;\">Starting time </span></p></body></html>", None))
        self.label_2.setText(_translate("Visualize other stations", "<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600;\">End Time </span></p></body></html>", None))
        self.label_6.setText(_translate("Visualize other stations", "<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600;\">Z: Zoom </span></p></body></html>", None))
        self.label_8.setText(_translate("Visualize other stations", "<html><head/><body><p align=\"center\"><span style=\" font-size:11pt; font-weight:600;\">S: Span</span></p></body></html>", None))
        self.pushfirst.setText(_translate("Visualize other stations", "Plot Trace", None))
        self.pushButton.setText(_translate("Visualize other stations", "Refresh", None))
        self.specgram_button.setText(_translate("Visualize other stations", "Plot Specgram", None))
