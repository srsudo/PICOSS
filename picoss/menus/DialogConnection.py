...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:11pt; font-weight:600;\">IP (or repository)</span></p></body></html>", None))
        self.label_2.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:11pt; font-weight:600;\">Port</span></p></body></html>", None))
        self.label_6.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:11pt; font-weight:600;\">Client</span></p></body></html>", None))
        self.comboServers.setItemText(0, _translate("MainWindow", "Earthworm", None))
        self.comboServers.setItemText(1, _translate("MainWindow", "Seedlink", None))
        self.comboServers.setItemText(2, _translate("MainWindow", "FDSN", None))
        self.comboServers.setItemText(3, _translate("MainWindow", "arclink", None))
        self.comboServers.setItemText(4, _translate("MainWindow", "IRIS", None))
        ...
        self.label_3.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:11pt; font-weight:600;\">Starting Time</span></p></body></html>", None))
        self.label_5.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:11pt; font-weight:600;\">Ending Time</span></p></body></html>", None))
        self.requestbutton.setText(_translate("MainWindow", "Request and Plot", None))
